...
@section('content')
    <div class="container d-flex justify-content-center flex-column">
        <div class="card d-flex flex-column justify-content-center shadow-sm" style="background-color: #D1F8FC">
            ...
            <div class="d-flex justify-content-end flex-row max-height:50%">
                <div class="ms-4 me-4 mb-3">
                    <img src="./ayam.png" alt="">
                </div>
                <div class="d-flex justify-content-center flex-column ">
                    <h3 class="fw-bold">Nama Perusahaan</h3>
                    <p class="fs-4" style="color: #029BB0">Ekosistem yang menghubungkan para stakeholder di bidang pembangunan. Mari majukan industri pembangunan Indonesia!</p>
                    <table>
                        <tr>
                            <th class="fs-4" style="color: #5E5E5E; width:130px">Lokasi</th>
                            <th class="fs-4">Jakarta</th>
                            <th class="fs-4" style="color: #5E5E5E; width:130px">Email</th>
                            <th class="fs-4">PTMakmur@company.com</th>
                        </tr>
                        <tr>
                            <th class="fs-4" style="color: #5E5E5E; width:130px">Website</th>
                            <th class="fs-4">WWW.Makmurpt.com</th>
                            <th class="fs-4" style="color: #5E5E5E; width:130px">Karyawan</th>
                            <th class="fs-4">20-50</th>
                        </tr>
                    </table>
                </div>
            </div>
            <div class="ps-4 pe-4 pb-3">
                ...
                <p class="fs-5">PT Makmur adalah startup ekosistem yang menghubungkan para stakeholder di bidang pembangunan seperti toko bangunan, kontraktor, perencana pembangunan, para tukang hingga consumer akhir yang ingin membangun sesuatu. Mari majukan industri pembangunan Indonesia bersama PT Makmur!</p>
            </div>
        </div>
        ...
        <div class="card d-flex flex-column justify-content-center shadow-sm mt-2 p-4" style="background-color: #ECA70A ">
            <div class="d-flex flex-row align-items-center justify-content-between">
                ...
                <a href="/addJob" class="btn mb-2 ">
                    <h4 style="color: #FFFFFF">+ Add Job</h4>
                </a>
            </div>
            <div class="d-flex flex-row align-items-center justify-content-between">
                <div class="d-flex flex-column ">
                    <h5 style="color: #FFFFFF">UI/UX Designer</h5>
                    <div class="d-flex flex-row align-items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-card-checklist mb-1" viewBox="0 0 16 16">
                          ...
                          <h5 class="ms-2">Fulltime</h5>
                    </div>
                </div>
                <div>
                    <a href="/detailAdmin" class="btn btn-light fw-bold fs-5" style="width: 120px">Edit</a>
                    <a href="/companyAdmin" class="btn fw-bold fs-5" style="width: 120px; background-color: #FFE351">Delete</a>
                </div>
            </div>
        </div>
    </div>
