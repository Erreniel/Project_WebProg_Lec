...
<div style="background-image: url(/asset/bg_login-signup-profile.png); background-size: cover; background-repeat: no-repeat; height:100vh">
    <div class="pt-5 d-flex justify-content-end" style="padding-right:20px">
        <img src="./asset/logo.png" style="width: 106px;">
    </div>
    <div class="pt-5">
        <div class="card d-flex flex-column justify-content-center m-auto" style="border-radius: 29px; width: 539px; height: 452px;">
